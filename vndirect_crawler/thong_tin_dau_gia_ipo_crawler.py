...
def thong_tin_dau_gia_ipo(urls):
    ...
    for url in urls:
        ...
        for new in news_info:
            ...
            db.Thong_Tin_Dau_Gia_IPO.insert_one(data_temp)
...
urls = ["https://www.vndirect.com.vn/category/thong-tin-dau-gia/"]
for x in range(2,78):
    urls.append("https://www.vndirect.com.vn/category/thong-tin-dau-gia/page/" + str(x)+ "/")
thong_tin_dau_gia_ipo(urls)